...
<STRING> {
    ...
    {LineTerminator}               {  throw new LexicalError("String wasn't terminated", yyline, string.toString());}
}
...
<YYINITIAL> {
    ...
    {IllegalInteger}        { throw new LexicalError("illegal character", yyline, yytext()); }
}
